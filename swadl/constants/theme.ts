...
export const typography = {
  ...
  headingLG:  { fontSize: 22, lineHeight: 26,  letterSpacing: -0.3, fontFamily: 'Baloo2_700Bold' },
  headingSM:  { fontSize: 16, lineHeight: 22,  letterSpacing: 0,    fontFamily: 'Nunito_700Bold' },
  body:       { fontSize: 14, lineHeight: 22,  letterSpacing: 0,    fontFamily: 'Nunito_400Regular' },
  bodyBold:   { fontSize: 14, lineHeight: 22,  letterSpacing: 0,    fontFamily: 'Nunito_700Bold' },
  label:      { fontSize: 11, lineHeight: 16,  letterSpacing: 2,    fontFamily: 'Baloo2_700Bold',     textTransform: 'uppercase' as const },
  caption:    { fontSize: 12, lineHeight: 18,  letterSpacing: 0,    fontFamily: 'Nunito_400Regular' },
  pillLabel:  { fontSize: 12, lineHeight: 16,  letterSpacing: 0.3,  fontFamily: 'Baloo2_700Bold' },
  ...
  monoXS:     { fontSize: 10, lineHeight: 16,  letterSpacing: -0.3, fontFamily: 'JetBrainsMono_400Regular' },
} as const;
